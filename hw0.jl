...
student = (name = "Alex", kerberos_id = "null")
...
function basic_square(x)
	return x^2 # this is wrong, write your code here!
end
...
function newton_sqrt(x, error_margin=0.0000000001, a=x/2 ) # a=x/2 is the default value of `a`
